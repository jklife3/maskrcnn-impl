...
class MaskRCNN():
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        offsets: [(x,y)] Center point of each box
        size_percentage [N] Float of each box size of the entire image
        """
        ...
        weight, height = image_shape[0], image_shape[1]

        offsets, size_percentages = [], []
        for b in boxes:
            y1, x1, y2, x2 = b
            offset = ((x1 / weight + x2 / weight) / 2, ((1 - y2 / height) + (1 - y1 / height)) / 2)
            offsets.append(offset)
            size_percentage = (x2 - x1) * (y2 - y1) / (weight * height)
            size_percentages.append(size_percentage)

        return boxes, class_ids, scores, full_masks, offsets, size_percentages
    ...
    def detect(self, images, verbose=0):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks, final_offsets, final_sizepercentages =\
            ...
            results.append({
                ...
                "size_percentage": final_sizepercentages
            })
        return results
